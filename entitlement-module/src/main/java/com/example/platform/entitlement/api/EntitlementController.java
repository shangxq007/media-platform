...
public class EntitlementController {
    ...
    public Map<String, Object> getMyCapabilities(
        ...
        PrincipalRef principal = PrincipalRef.tenantScoped(
                effectiveTenant, PrincipalType.USER, effectiveUser);
        return Map.of(
                "tenantId", effectiveTenant,
                "userId", effectiveUser,
                "commercialTierMetadata", entitlementPolicyService.getTier(effectiveTenant),
                "entitlements", entitlementService.getSnapshot(principal)
        );
    }
    ...
    public Map<String, Object> validateExport(
        ...
        result.put("authority", "EntitlementService");
        return result;
    }
