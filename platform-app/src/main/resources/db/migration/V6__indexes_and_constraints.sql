...
-- =============================================================================
-- V2 tables: storage_object, prompt_execution_log, extension_invocation
-- =============================================================================
...
-- prompt_execution_log: queried by template_code for execution history
create index if not exists ix_prompt_execution_log_template_code on prompt_execution_log(template_code);
