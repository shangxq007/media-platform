...
class ProductAssetReadContainmentTest {

    @Test
    void productRoutesDenyBeforeGlobalIdReadsOrDependencyMutations() throws Exception {
        assertMappedMethodsUnavailable(ProductController.class, Set.of(
                "get", "listByProject", "listByAsset", "getDependencies", "linkDependency", "unlink"));
    }

    @Test
    void assetWorkbenchRoutesDenyBeforeStorageGovernanceOwnerOrSemanticDisclosure() throws Exception {
        assertMappedMethodsUnavailable(AssetWorkbenchController.class, Set.of(
                "workbench", "semantic", "governance", "marketplace", "search"));
    }
    ...
    private static Object[] nullArguments(Method method) {
        return Arrays.stream(method.getParameterTypes())
                .map(ProductAssetReadContainmentTest::defaultValue)
                .toArray();
    }
