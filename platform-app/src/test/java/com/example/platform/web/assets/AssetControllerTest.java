...
class AssetControllerTest {
    ...
    void shouldListAssets() {
        ...
        ResponseEntity<List<AssetController.AssetResponse>> response = controller.listAssets("proj-1");
    ...
    void shouldGetAsset() {
        ...
        ResponseEntity<AssetController.AssetResponse> response = controller.getAsset("proj-1", "a1");
