...
class TimelineReviewOwnerIntegrationTest extends PostgresTestContainerSupport {
 ...
 @BeforeAll static void setup(){
  ...
  context.registerBean(OutboxEventRouter.class,()->new OutboxEventRouter(List.of(new TimelineReviewOutboxEvents())));
 ...
 @Test void externalEntryUsesAuthenticatedOwnerAndDurableDispatch(){
  ...
  String approved=jdbc.queryForObject("select id from outbox_events where aggregate_id=? and event_type='review.approved'",String.class,id);
