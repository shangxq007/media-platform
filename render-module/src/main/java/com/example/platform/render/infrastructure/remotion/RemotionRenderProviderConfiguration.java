...
@EnableConfigurationProperties(RemotionRenderProviderProperties.class)
public class RemotionRenderProviderConfiguration {
    ...
    RemotionRenderProvider remotionRenderProvider(ProcessToolRunner processToolRunner,
        ...
        return new RemotionRenderProvider(processToolRunner, properties, timelineScriptParser);
    }
}
