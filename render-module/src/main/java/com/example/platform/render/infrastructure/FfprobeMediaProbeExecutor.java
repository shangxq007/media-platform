...
@Service
public class FfprobeMediaProbeExecutor {
    private static final Logger log = LoggerFactory.getLogger(FfprobeMediaProbeExecutor.class);
    ...
    public FfprobeMediaProbeExecutor(MediaProbeAdapter probeAdapter) {
