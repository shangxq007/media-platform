...
public class DefaultRenderPlanner implements RenderPlanner {
    ...
    private ProviderRenderPlan planCaptionedVideoExport(RenderJob job) {
        ...
        steps.add(new RenderStep(
                "step-1-extract-audio", ProviderType.RENDER, null,
        ...
        steps.add(new RenderStep(
                "step-3-output-normalize", ProviderType.RENDER, null,
    ...
    private ProviderRenderPlan planHlsPackageExport(RenderJob job) {
        ...
        steps.add(new RenderStep(
                "step-1-output-normalize", ProviderType.RENDER, null,
    ...
    private ProviderRenderPlan planTimelineExport(RenderJob job) {
        ...
        steps.add(new RenderStep(
                "step-2-output-normalize", ProviderType.RENDER, null,
