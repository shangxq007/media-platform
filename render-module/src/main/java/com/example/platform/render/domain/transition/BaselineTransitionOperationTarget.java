...
/**
 * Semantic target for a baseline transition operation.
 * References timeline entities only — no provider/storage internals.
 * Immutable. Internal domain model.
 */
public record BaselineTransitionOperationTarget(
        BaselineTransitionOperationTargetType targetType,
        String fromClipId,
        String toClipId,
        String trackId,
        String timelineId,
    ...
    public BaselineTransitionOperationTarget {
