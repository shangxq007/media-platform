...
class TimelineMergeConflictDetectorTest {
    ...
    void sameMetadataKeyDiffValueManualReview() {
        ...
        CanonicalTimelineSnapshot ours = new CanonicalTimelineSnapshot(
                snapId("s1"), "rev-ours", MediaTime.ofMillis(5000),
                List.of(), List.of(), List.of(), List.of(), List.of(), null,
                Map.of("title", "Ours Title"), List.of());
        CanonicalTimelineSnapshot theirs = new CanonicalTimelineSnapshot(
                snapId("s1"), "rev-theirs", MediaTime.ofMillis(5000),
                List.of(), List.of(), List.of(), List.of(), List.of(), null,
                Map.of("title", "Theirs Title"), List.of());
    ...
    void outputProfileOneSideMergeReady() {
        ...
        CanonicalTimelineSnapshot ours = new CanonicalTimelineSnapshot(
                snapId("s1"), "rev-ours", MediaTime.ofMillis(5000),
                List.of(), List.of(), List.of(), List.of(), List.of(), profile, Map.of(), List.of());
    ...
    void differentCaptionsChangedMergeReady() {
        ...
        CanonicalTimelineSnapshot base = new CanonicalTimelineSnapshot(
                snapId("s1"), "rev-1", MediaTime.ofMillis(5000),
                List.of(), List.of(cap1, cap2), List.of(), List.of(), List.of(), null, Map.of(), List.of());
        ...
        CanonicalTimelineSnapshot ours = new CanonicalTimelineSnapshot(
                snapId("s1"), "rev-ours", MediaTime.ofMillis(5000),
                List.of(), List.of(cap1ours, cap2), List.of(), List.of(), List.of(), null, Map.of(), List.of());
        ...
        CanonicalTimelineSnapshot theirs = new CanonicalTimelineSnapshot(
                snapId("s1"), "rev-theirs", MediaTime.ofMillis(5000),
                List.of(), List.of(cap1, cap2theirs), List.of(), List.of(), List.of(), null, Map.of(), List.of());
    ...
    void sameCaptionTextSameValueMergeReady() {
        ...
        CanonicalTimelineSnapshot ours = new CanonicalTimelineSnapshot(
                snapId("s1"), "rev-ours", MediaTime.ofMillis(5000),
                List.of(), List.of(capChanged), List.of(), List.of(), List.of(), null, Map.of(), List.of());
        CanonicalTimelineSnapshot theirs = new CanonicalTimelineSnapshot(
                snapId("s1"), "rev-theirs", MediaTime.ofMillis(5000),
                List.of(), List.of(capChanged), List.of(), List.of(), List.of(), null, Map.of(), List.of());
    ...
    void differentClipsChangedMergeReady() {
        ...
        CanonicalTimelineSnapshot base = new CanonicalTimelineSnapshot(
                ...
                List.of(track), List.of(), List.of(), List.of(), List.of(), null, Map.of(), List.of());
        ...
        CanonicalTimelineSnapshot ours = new CanonicalTimelineSnapshot(
                ...
                List.of(trackOurs), List.of(), List.of(), List.of(), List.of(), null, Map.of(), List.of());
        ...
        CanonicalTimelineSnapshot theirs = new CanonicalTimelineSnapshot(
                ...
                List.of(trackTheirs), List.of(), List.of(), List.of(), List.of(), null, Map.of(), List.of());
    ...
    void trackReorderedDifferentlyConflict() {
        ...
        CanonicalTimelineSnapshot ours = new CanonicalTimelineSnapshot(
                snapId("s1"), "rev-ours", MediaTime.ofMillis(5000),
                List.of(t1ours, t2), List.of(), List.of(), List.of(), List.of(), null, Map.of(), List.of());

        CanonicalTimelineTrackSnapshot t1theirs = new CanonicalTimelineTrackSnapshot(
                "track-1", 9, "VIDEO", List.of(), Map.of());
        CanonicalTimelineSnapshot theirs = new CanonicalTimelineSnapshot(
                snapId("s1"), "rev-theirs", MediaTime.ofMillis(5000),
                List.of(t1theirs, t2), List.of(), List.of(), List.of(), List.of(), null, Map.of(), List.of());
    ...
    void differentTemplateParamsMergeReady() {
        ...
        CanonicalTimelineSnapshot base = new CanonicalTimelineSnapshot(
                snapId("s1"), "rev-1", MediaTime.ofMillis(5000),
                List.of(), List.of(), List.of(), List.of(ta1, ta2), List.of(), null, Map.of(), List.of());
        ...
        CanonicalTimelineSnapshot ours = new CanonicalTimelineSnapshot(
                snapId("s1"), "rev-ours", MediaTime.ofMillis(5000),
                List.of(), List.of(), List.of(), List.of(ta1ours, ta2), List.of(), null, Map.of(), List.of());
        ...
        CanonicalTimelineSnapshot theirs = new CanonicalTimelineSnapshot(
                snapId("s1"), "rev-theirs", MediaTime.ofMillis(5000),
                List.of(), List.of(), List.of(), List.of(ta1, ta2theirs), List.of(), null, Map.of(), List.of());
    ...
    void sameTemplateParamDifferentConflict() {
        ...
        CanonicalTimelineSnapshot base = new CanonicalTimelineSnapshot(
                snapId("s1"), "rev-1", MediaTime.ofMillis(5000),
                List.of(), List.of(), List.of(), List.of(ta), List.of(), null, Map.of(), List.of());
        ...
        CanonicalTimelineSnapshot ours = new CanonicalTimelineSnapshot(
                snapId("s1"), "rev-ours", MediaTime.ofMillis(5000),
                List.of(), List.of(), List.of(), List.of(taOurs), List.of(), null, Map.of(), List.of());
        ...
        CanonicalTimelineSnapshot theirs = new CanonicalTimelineSnapshot(
                snapId("s1"), "rev-theirs", MediaTime.ofMillis(5000),
                List.of(), List.of(), List.of(), List.of(taTheirs), List.of(), null, Map.of(), List.of());
    ...
    void workflowStepChangedDifferentlyConflict() {
        ...
        CanonicalTimelineSnapshot base = new CanonicalTimelineSnapshot(
                snapId("s1"), "rev-1", MediaTime.ofMillis(5000),
                List.of(), List.of(), List.of(), List.of(), List.of(ws), null, Map.of(), List.of());
        ...
        CanonicalTimelineSnapshot ours = new CanonicalTimelineSnapshot(
                snapId("s1"), "rev-ours", MediaTime.ofMillis(5000),
                List.of(), List.of(), List.of(), List.of(), List.of(wsOurs), null, Map.of(), List.of());
        ...
        CanonicalTimelineSnapshot theirs = new CanonicalTimelineSnapshot(
                snapId("s1"), "rev-theirs", MediaTime.ofMillis(5000),
                List.of(), List.of(), List.of(), List.of(), List.of(wsTheirs), null, Map.of(), List.of());
    ...
    void bothSidesFullRerenderConservative() {
        ...
        CanonicalTimelineSnapshot theirs = new CanonicalTimelineSnapshot(
                ...
                base.tracks(), List.of(), List.of(), List.of(), List.of(), null, Map.of(), List.of());
    ...
    void deterministicConflictOrdering() {
        ...
        CanonicalTimelineSnapshot base = new CanonicalTimelineSnapshot(
                snapId("s1"), "rev-1", MediaTime.ofMillis(5000),
                List.of(track), List.of(cap), List.of(), List.of(), List.of(), null, Map.of(), List.of());
        ...
        CanonicalTimelineSnapshot ours = new CanonicalTimelineSnapshot(
                snapId("s1"), "rev-ours", MediaTime.ofMillis(5000),
                List.of(trackOurs), List.of(capOurs), List.of(), List.of(), List.of(), null, Map.of(), List.of());
        ...
        CanonicalTimelineSnapshot theirs = new CanonicalTimelineSnapshot(
                snapId("s1"), "rev-theirs", MediaTime.ofMillis(5000),
                List.of(trackTheirs), List.of(capTheirs), List.of(), List.of(), List.of(), null, Map.of(), List.of());
