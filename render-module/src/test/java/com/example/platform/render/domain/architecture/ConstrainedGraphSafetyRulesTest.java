...
import com.example.platform.timeline.diff.application.*;
...
class ConstrainedGraphSafetyRulesTest {
    ...
    private CanonicalTimelineSnapshot simpleSnapshot(String revisionId) {
        return new CanonicalTimelineSnapshot(
                ...
                Map.of(), List.of(), List.of(), List.of(), com.example.platform.audio.domain.mix.AudioMix.empty(), java.util.List.of());
    }
}