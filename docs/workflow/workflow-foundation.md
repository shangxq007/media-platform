...
- LOOP has one body, a deterministic predicate and `bound` in 1..1000. IS_SET/IS_EMPTY may inspect a declared body result before the first iteration (unset initially). Exhausting the bound is a failure, not successful completion or a retry.
