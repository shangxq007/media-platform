...
`;case`vs0VerticalSlice`:return`digraph {
    ...
    subgraph cluster_rendermodule {
        ...
        assstylemapper [height=2.5,
            ...
            margin="0.223,0.223",
            width=4.445];
        renderjobclaimservice [height=2.5,
            label=<<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="4"><TR><TD><FONT POINT-SIZE="20">RenderJob Claim Service</FONT></TD></TR><TR><TD><FONT POINT-SIZE="15" COLOR="#bfdbfe">Atomic CAS: QUEUED → SELECTING_PROVIDER via<BR/>REQUIRES_NEW transaction</FONT></TD></TR></TABLE>>,
            likec4_id="mediaPlatform.renderModule.renderJobClaimService",
            likec4_level=1,
            margin="0.223,0.223",
            width=4.445];
        renderjobfailureservice [height=2.5,
            label=<<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="4"><TR><TD><FONT POINT-SIZE="20">RenderJob Failure Service</FONT></TD></TR><TR><TD><FONT POINT-SIZE="15" COLOR="#bfdbfe">Durable failure persistence via REQUIRES_NEW<BR/>transaction. States: SELECTING_PROVIDER,<BR/>PROVIDER_SELECTED, EXECUTING, COMPLETING</FONT></TD></TR></TABLE>>,
            likec4_id="mediaPlatform.renderModule.renderJobFailureService",
            likec4_level=1,
            margin="0.223,0.223",
            width=4.445];
        renderjobstatemachine [height=2.5,
            label=<<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="4"><TR><TD><FONT POINT-SIZE="20">RenderJob State Machine</FONT></TD></TR><TR><TD><FONT POINT-SIZE="15" COLOR="#bfdbfe">Lifecycle transitions: QUEUED →<BR/>SELECTING_PROVIDER → PROVIDER_SELECTED →<BR/>EXECUTING → COMPLETING → COMPLETED</FONT></TD></TR></TABLE>>,
            likec4_id="mediaPlatform.renderModule.renderJobStateMachine",
            likec4_level=1,
            margin="0.223,0.223",
            width=4.445];
        ...
        productruntime [height=2.5,
            ...
            margin="0.223,0.223",
            width=4.445];
        providerregistry [height=2.5,
            label=<<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="4"><TR><TD><FONT POINT-SIZE="20">Provider Registry</FONT></TD></TR><TR><TD><FONT POINT-SIZE="15" COLOR="#bfdbfe">Canonical Provider ID management. Registry<BR/>key: ffmpeg (not class name)</FONT></TD></TR></TABLE>>,
            likec4_id="mediaPlatform.renderModule.providerRegistry",
            likec4_level=1,
            margin="0.223,0.223",
            width=4.445];
    ...
    captiontemplate -> assstylemapper [arrowhead=normal,
        ...
        likec4_id="1ojuwrd",
        style=dashed];
    previewrenderjobservice -> renderjobclaimservice [arrowhead=normal,
        label=<<TABLE BORDER="0" CELLPADDING="3" CELLSPACING="0" BGCOLOR="#18191BA0"><TR><TD ALIGN="TEXT" BALIGN="LEFT"><FONT POINT-SIZE="14">claims execution</FONT></TD></TR></TABLE>>,
        likec4_id="54dtai",
        style=dashed,
        weight=2];
    previewrenderjobservice -> renderjobfailureservice [arrowhead=normal,
        label=<<TABLE BORDER="0" CELLPADDING="3" CELLSPACING="0" BGCOLOR="#18191BA0"><TR><TD ALIGN="TEXT" BALIGN="LEFT"><FONT POINT-SIZE="14">records failure</FONT></TD></TR></TABLE>>,
        likec4_id=cwlwg0,
        minlen=1,
        style=dashed,
        weight=2];
    previewrenderjobservice -> renderjobstatemachine [arrowhead=normal,
        label=<<TABLE BORDER="0" CELLPADDING="3" CELLSPACING="0" BGCOLOR="#18191BA0"><TR><TD ALIGN="TEXT" BALIGN="LEFT"><FONT POINT-SIZE="14">transitions state</FONT></TD></TR></TABLE>>,
        likec4_id="1eig0hb",
        minlen=1,
        style=dashed,
        weight=2];
    ...
    assstylemapper -> providerbinding [arrowhead=normal,
        ...
        likec4_id=dyb7bb,
        style=dashed];
    renderjobclaimservice -> providerregistry [arrowhead=normal,
        label=<<TABLE BORDER="0" CELLPADDING="3" CELLSPACING="0" BGCOLOR="#18191BA0"><TR><TD ALIGN="TEXT" BALIGN="LEFT"><FONT POINT-SIZE="14">verifies provider</FONT></TD></TR></TABLE>>,
        likec4_id="19x151g",
        style=dashed];
    providerbinding -> ffmpegbaseline [arrowhead=normal,
        ...
        likec4_id=q47oy6,
        style=dashed];
    providerbinding -> providerregistry [arrowhead=normal,
        label=<<TABLE BORDER="0" CELLPADDING="3" CELLSPACING="0" BGCOLOR="#18191BA0"><TR><TD ALIGN="TEXT" BALIGN="LEFT"><FONT POINT-SIZE="14">resolves by canonical ID</FONT></TD></TR></TABLE>>,
        likec4_id="1714rmm",
        style=dashed];
    ffmpegbaseline -> productruntime [arrowhead=normal,
        ...
        likec4_id="4joqk9",
        style=dashed];
    ffmpegbaseline -> providerregistry [arrowhead=normal,
        label=<<TABLE BORDER="0" CELLPADDING="3" CELLSPACING="0" BGCOLOR="#18191BA0"><TR><TD ALIGN="TEXT" BALIGN="LEFT"><FONT POINT-SIZE="14">registers as ffmpeg</FONT></TD></TR></TABLE>>,
        likec4_id="1mcxdui",
        style=dashed];
...
`;case`renderJobClaimFailureArchitecture`:return`digraph {
    graph [TBbalance=min,
        bgcolor=transparent,
        compound=true,
        fontname=Arial,
        ...
        labelloc=t,
        layout=dot,
        likec4_viewId=renderJobClaimFailureArchitecture,
        nodesep=1.528,
        outputorder=nodesfirst,
        pad=0.209,
        rankdir=TB,
...
<!-- Generated by graphviz version 14.1.5 (0)
 -->
<!-- Pages: 1 -->
<svg width="2922pt" height="2539pt"
 viewBox="0.00 0.00 2922.00 2539.00" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
<g id="graph0" class="graph" transform="scale(1 1) rotate(0) translate(15.05 2523.85)">
<g id="clust1" class="cluster">
<title>cluster_rendermodule</title>
<polygon fill="#194b9e" stroke="#1b3d88" points="8,-282.8 8,-2500.8 2532,-2500.8 2532,-282.8 8,-282.8"/>
...
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="902.73,-2439.6 553.27,-2439.6 553.27,-2259.6 902.73,-2259.6 902.73,-2439.6"/>
<text xml:space="preserve" text-anchor="start" x="621.3" y="-2361.6" font-family="Arial" font-size="20.00" fill="#eff6ff">Timeline Edit Command</text>
<text xml:space="preserve" text-anchor="start" x="573.33" y="-2338.6" font-family="Arial" font-size="15.00" fill="#bfdbfe">TL.0: Sealed interface with 12 typed command</text>
<text xml:space="preserve" text-anchor="start" x="702.99" y="-2320.6" font-family="Arial" font-size="15.00" fill="#bfdbfe">records</text>
</g>
<!-- faketestlayer -->
<g id="node2" class="node">
<title>faketestlayer</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="2312.02,-2439.6 1991.98,-2439.6 1991.98,-2259.6 2312.02,-2259.6 2312.02,-2439.6"/>
<text xml:space="preserve" text-anchor="start" x="2079.75" y="-2361.6" font-family="Arial" font-size="20.00" fill="#eff6ff">Fake Test Layer</text>
<text xml:space="preserve" text-anchor="start" x="2019.45" y="-2338.6" font-family="Arial" font-size="15.00" fill="#bfdbfe">VS.1&#45;TEST.1: Fake implementations for</text>
<text xml:space="preserve" text-anchor="start" x="2092.79" y="-2320.6" font-family="Arial" font-size="15.00" fill="#bfdbfe">integration testing</text>
</g>
<!-- captiontemplate -->
<g id="node3" class="node">
<title>captiontemplate</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="895.21,-2116.8 560.79,-2116.8 560.79,-1936.8 895.21,-1936.8 895.21,-2116.8"/>
<text xml:space="preserve" text-anchor="start" x="649.07" y="-2038.8" font-family="Arial" font-size="20.00" fill="#eff6ff">Caption Template</text>
<text xml:space="preserve" text-anchor="start" x="580.84" y="-2015.8" font-family="Arial" font-size="15.00" fill="#bfdbfe">CT.0: Typed intent model for caption/subtitle</text>
<text xml:space="preserve" text-anchor="start" x="696.31" y="-1997.8" font-family="Arial" font-size="15.00" fill="#bfdbfe">rendering</text>
</g>
<!-- previewrenderjobservice -->
<g id="node4" class="node">
<title>previewrenderjobservice</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="1794.02,-1794 1473.98,-1794 1473.98,-1614 1794.02,-1614 1794.02,-1794"/>
<text xml:space="preserve" text-anchor="start" x="1507.83" y="-1707" font-family="Arial" font-size="20.00" fill="#eff6ff">Preview Render Job Service</text>
<text xml:space="preserve" text-anchor="start" x="1522.28" y="-1684" font-family="Arial" font-size="15.00" fill="#bfdbfe">VS.1: Preview render job lifecycle</text>
</g>
<!-- previewartifactqueryservice -->
<g id="node5" class="node">
<title>previewartifactqueryservice</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="2445.02,-1148.4 2124.98,-1148.4 2124.98,-968.4 2445.02,-968.4 2445.02,-1148.4"/>
<text xml:space="preserve" text-anchor="start" x="2149.4" y="-1061.4" font-family="Arial" font-size="20.00" fill="#eff6ff">Preview Artifact Query Service</text>
<text xml:space="preserve" text-anchor="start" x="2159.94" y="-1038.4" font-family="Arial" font-size="15.00" fill="#bfdbfe">VS.1: Product/artifact metadata query</text>
</g>
<!-- assstylemapper -->
<g id="node6" class="node">
<title>assstylemapper</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="911.88,-1794 544.12,-1794 544.12,-1614 911.88,-1614 911.88,-1794"/>
<text xml:space="preserve" text-anchor="start" x="655.19" y="-1716" font-family="Arial" font-size="20.00" fill="#eff6ff">AssStyleMapper</text>
<text xml:space="preserve" text-anchor="start" x="564.18" y="-1693" font-family="Arial" font-size="15.00" fill="#bfdbfe">CT.0: Maps CaptionTemplateSpec to ASS format</text>
<text xml:space="preserve" text-anchor="start" x="690.07" y="-1675" font-family="Arial" font-size="15.00" fill="#bfdbfe">parameters</text>
</g>
<!-- renderjobclaimservice -->
<g id="node7" class="node">
<title>renderjobclaimservice</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="457.68,-1471.2 48.32,-1471.2 48.32,-1291.2 457.68,-1291.2 457.68,-1471.2"/>
<text xml:space="preserve" text-anchor="start" x="139.62" y="-1393.2" font-family="Arial" font-size="20.00" fill="#eff6ff">RenderJob Claim Service</text>
<text xml:space="preserve" text-anchor="start" x="68.37" y="-1370.2" font-family="Arial" font-size="15.00" fill="#bfdbfe">Atomic CAS: QUEUED → SELECTING_PROVIDER via</text>
<text xml:space="preserve" text-anchor="start" x="153.39" y="-1352.2" font-family="Arial" font-size="15.00" fill="#bfdbfe">REQUIRES_NEW transaction</text>
</g>
<!-- renderjobfailureservice -->
<g id="node8" class="node">
<title>renderjobfailureservice</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="2379.67,-1471.2 1970.33,-1471.2 1970.33,-1291.2 2379.67,-1291.2 2379.67,-1471.2"/>
<text xml:space="preserve" text-anchor="start" x="2056.61" y="-1402.2" font-family="Arial" font-size="20.00" fill="#eff6ff">RenderJob Failure Service</text>
<text xml:space="preserve" text-anchor="start" x="2011.19" y="-1379.2" font-family="Arial" font-size="15.00" fill="#bfdbfe">Durable failure persistence via REQUIRES_NEW</text>
<text xml:space="preserve" text-anchor="start" x="2020.78" y="-1361.2" font-family="Arial" font-size="15.00" fill="#bfdbfe">transaction. States: SELECTING_PROVIDER,</text>
<text xml:space="preserve" text-anchor="start" x="1990.38" y="-1343.2" font-family="Arial" font-size="15.00" fill="#bfdbfe">PROVIDER_SELECTED, EXECUTING, COMPLETING</text>
</g>
<!-- renderjobstatemachine -->
<g id="node9" class="node">
<title>renderjobstatemachine</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="1413.6,-1471.2 998.4,-1471.2 998.4,-1291.2 1413.6,-1291.2 1413.6,-1471.2"/>
<text xml:space="preserve" text-anchor="start" x="1090.38" y="-1402.2" font-family="Arial" font-size="20.00" fill="#eff6ff">RenderJob State Machine</text>
<text xml:space="preserve" text-anchor="start" x="1095.96" y="-1379.2" font-family="Arial" font-size="15.00" fill="#bfdbfe">Lifecycle transitions: QUEUED →</text>
<text xml:space="preserve" text-anchor="start" x="1018.45" y="-1361.2" font-family="Arial" font-size="15.00" fill="#bfdbfe">SELECTING_PROVIDER → PROVIDER_SELECTED →</text>
<text xml:space="preserve" text-anchor="start" x="1045.15" y="-1343.2" font-family="Arial" font-size="15.00" fill="#bfdbfe">EXECUTING → COMPLETING → COMPLETED</text>
</g>
<!-- providerbinding -->
<g id="node10" class="node">
<title>providerbinding</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="888.02,-1471.2 567.98,-1471.2 567.98,-1291.2 888.02,-1291.2 888.02,-1471.2"/>
<text xml:space="preserve" text-anchor="start" x="654.63" y="-1393.2" font-family="Arial" font-size="20.00" fill="#eff6ff">Provider Binding</text>
<text xml:space="preserve" text-anchor="start" x="594" y="-1370.2" font-family="Arial" font-size="15.00" fill="#bfdbfe">Deterministic eligibility + priority provider</text>
<text xml:space="preserve" text-anchor="start" x="698.4" y="-1352.2" font-family="Arial" font-size="15.00" fill="#bfdbfe">selection</text>
</g>
<!-- ffmpegbaseline -->
<g id="node11" class="node">
<title>ffmpegbaseline</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="1748.02,-1148.4 1427.98,-1148.4 1427.98,-968.4 1748.02,-968.4 1748.02,-1148.4"/>
<text xml:space="preserve" text-anchor="start" x="1481.29" y="-1061.4" font-family="Arial" font-size="20.00" fill="#eff6ff">FFmpeg/libass Baseline</text>
<text xml:space="preserve" text-anchor="start" x="1488.35" y="-1038.4" font-family="Arial" font-size="15.00" fill="#bfdbfe">Production rendering baseline</text>
</g>
<!-- productruntime -->
<g id="node12" class="node">
<title>productruntime</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="2065.02,-825.6 1744.98,-825.6 1744.98,-645.6 2065.02,-645.6 2065.02,-825.6"/>
<text xml:space="preserve" text-anchor="start" x="1830.52" y="-738.6" font-family="Arial" font-size="20.00" fill="#eff6ff">Product Runtime</text>
<text xml:space="preserve" text-anchor="start" x="1804.53" y="-715.6" font-family="Arial" font-size="15.00" fill="#bfdbfe">Product lifecycle management</text>
</g>
<!-- providerregistry -->
<g id="node13" class="node">
<title>providerregistry</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="898.54,-825.6 557.46,-825.6 557.46,-645.6 898.54,-645.6 898.54,-825.6"/>
<text xml:space="preserve" text-anchor="start" x="651.31" y="-747.6" font-family="Arial" font-size="20.00" fill="#eff6ff">Provider Registry</text>
<text xml:space="preserve" text-anchor="start" x="577.52" y="-724.6" font-family="Arial" font-size="15.00" fill="#bfdbfe">Canonical Provider ID management. Registry</text>
<text xml:space="preserve" text-anchor="start" x="631.71" y="-706.6" font-family="Arial" font-size="15.00" fill="#bfdbfe">key: ffmpeg (not class name)</text>
</g>
<!-- storageruntime -->
<g id="node14" class="node">
<title>storageruntime</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="2350.02,-502.8 2029.98,-502.8 2029.98,-322.8 2350.02,-322.8 2350.02,-502.8"/>
<text xml:space="preserve" text-anchor="start" x="2114.96" y="-415.8" font-family="Arial" font-size="20.00" fill="#eff6ff">Storage Runtime</text>
<text xml:space="preserve" text-anchor="start" x="2067.43" y="-392.8" font-family="Arial" font-size="15.00" fill="#bfdbfe">Storage/materialization management</text>
</g>
<!-- platformapp -->
<g id="node15" class="node">
<title>platformapp</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="2892.02,-2116.8 2571.98,-2116.8 2571.98,-1936.8 2892.02,-1936.8 2892.02,-2116.8"/>
<text xml:space="preserve" text-anchor="start" x="2675.86" y="-2029.8" font-family="Arial" font-size="20.00" fill="#eff6ff">platform&#45;app</text>
<text xml:space="preserve" text-anchor="start" x="2655.7" y="-2006.8" font-family="Arial" font-size="15.00" fill="#bfdbfe">Spring Boot entry point</text>
</g>
<!-- storage -->
<g id="node16" class="node">
<title>storage</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="2350.02,-180 2029.98,-180 2029.98,0 2350.02,0 2350.02,-180"/>
<text xml:space="preserve" text-anchor="start" x="2154.98" y="-93" font-family="Arial" font-size="20.00" fill="#eff6ff">Storage</text>
<text xml:space="preserve" text-anchor="start" x="2076.62" y="-70" font-family="Arial" font-size="15.00" fill="#bfdbfe">Object storage / shared filesystem</text>
</g>
<!-- timelineedit&#45;&gt;captiontemplate -->
<g id="edge3" class="edge">
<title>timelineedit&#45;&gt;captiontemplate</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M728,-2259.67C728,-2218.47 728,-2169.36 728,-2126.97"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="730.63,-2127.16 728,-2119.66 725.38,-2127.16 730.63,-2127.16"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="728,-2176.8 728,-2199.6 872.54,-2199.6 872.54,-2176.8 728,-2176.8"/>
<text xml:space="preserve" text-anchor="start" x="731" y="-2182.6" font-family="Arial" font-size="14.00" fill="#c9c9c9">generates typed intent</text>
</g>
<!-- faketestlayer&#45;&gt;previewrenderjobservice -->
<g id="edge4" class="edge">
<title>faketestlayer&#45;&gt;previewrenderjobservice</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M2080.52,-2259.79C1983.84,-2139.66 1812.02,-1926.18 1712.06,-1801.98"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="1714.22,-1800.49 1707.48,-1796.29 1710.13,-1803.78 1714.22,-1800.49"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="1961.34,-2015.4 1961.34,-2038.2 1996.9,-2038.2 1996.9,-2015.4 1961.34,-2015.4"/>
<text xml:space="preserve" text-anchor="start" x="1964.34" y="-2021.2" font-family="Arial" font-size="14.00" fill="#c9c9c9">tests</text>
</g>
<!-- faketestlayer&#45;&gt;previewartifactqueryservice -->
<g id="edge5" class="edge">
<title>faketestlayer&#45;&gt;previewartifactqueryservice</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M2191,-2259.62C2257.02,-2103.63 2388.15,-1769.04 2435,-1471.2 2447.43,-1392.17 2457.66,-1367.92 2435,-1291.2 2420.84,-1243.24 2393.3,-1195.87 2365.65,-1156.58"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="2368.01,-1155.36 2361.51,-1150.78 2363.74,-1158.41 2368.01,-1155.36"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="2406.68,-1692.6 2406.68,-1715.4 2442.24,-1715.4 2442.24,-1692.6 2406.68,-1692.6"/>
<text xml:space="preserve" text-anchor="start" x="2409.68" y="-1698.4" font-family="Arial" font-size="14.00" fill="#c9c9c9">tests</text>
</g>
<!-- captiontemplate&#45;&gt;assstylemapper -->
<g id="edge6" class="edge">
<title>captiontemplate&#45;&gt;assstylemapper</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M728,-1936.87C728,-1895.67 728,-1846.56 728,-1804.17"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="730.63,-1804.36 728,-1796.86 725.38,-1804.36 730.63,-1804.36"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="728,-1854 728,-1876.8 890.4,-1876.8 890.4,-1854 728,-1854"/>
<text xml:space="preserve" text-anchor="start" x="731" y="-1859.8" font-family="Arial" font-size="14.00" fill="#c9c9c9">maps to ASS parameters</text>
</g>
<!-- previewrenderjobservice&#45;&gt;renderjobclaimservice -->
<g id="edge7" class="edge">
<title>previewrenderjobservice&#45;&gt;renderjobclaimservice</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M1474,-1665.17C1317.8,-1628.79 1073.2,-1573.27 860,-1531.2 706.45,-1500.9 664.63,-1510 513,-1471.2 498.12,-1467.39 482.87,-1463.13 467.57,-1458.6"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="468.36,-1456.09 460.42,-1456.45 466.85,-1461.12 468.36,-1456.09"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="965.68,-1531.2 965.68,-1554 1075.17,-1554 1075.17,-1531.2 965.68,-1531.2"/>
<text xml:space="preserve" text-anchor="start" x="968.68" y="-1537" font-family="Arial" font-size="14.00" fill="#c9c9c9">claims execution</text>
</g>
<!-- previewrenderjobservice&#45;&gt;renderjobfailureservice -->
<g id="edge8" class="edge">
<title>previewrenderjobservice&#45;&gt;renderjobfailureservice</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M1785.26,-1614.11C1818.78,-1594.35 1854.11,-1573.49 1887,-1554 1929.32,-1528.92 1975.07,-1501.68 2017.39,-1476.44"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="2018.66,-1478.73 2023.76,-1472.64 2015.97,-1474.22 2018.66,-1478.73"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="1918.28,-1531.2 1918.28,-1554 2012.98,-1554 2012.98,-1531.2 1918.28,-1531.2"/>
<text xml:space="preserve" text-anchor="start" x="1921.28" y="-1537" font-family="Arial" font-size="14.00" fill="#c9c9c9">records failure</text>
</g>
<!-- previewrenderjobservice&#45;&gt;renderjobstatemachine -->
<g id="edge9" class="edge">
<title>previewrenderjobservice&#45;&gt;renderjobstatemachine</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M1515.35,-1614.07C1458.52,-1571.47 1390.42,-1520.43 1332.6,-1477.09"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="1334.51,-1475.24 1326.94,-1472.85 1331.36,-1479.44 1334.51,-1475.24"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="1432.83,-1531.2 1432.83,-1554 1536.88,-1554 1536.88,-1531.2 1432.83,-1531.2"/>
<text xml:space="preserve" text-anchor="start" x="1435.83" y="-1537" font-family="Arial" font-size="14.00" fill="#c9c9c9">transitions state</text>
</g>
<!-- previewrenderjobservice&#45;&gt;providerbinding -->
<g id="edge10" class="edge">
<title>previewrenderjobservice&#45;&gt;providerbinding</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M1474.31,-1650.84C1302.71,-1594.55 1041.36,-1508.01 943,-1471.2 928.12,-1465.63 912.73,-1459.67 897.35,-1453.57"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="898.53,-1451.22 890.59,-1450.88 896.59,-1456.1 898.53,-1451.22"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="1177.33,-1531.2 1177.33,-1554 1268.93,-1554 1268.93,-1531.2 1177.33,-1531.2"/>
<text xml:space="preserve" text-anchor="start" x="1180.33" y="-1537" font-family="Arial" font-size="14.00" fill="#c9c9c9">compiles plan</text>
</g>
<!-- previewrenderjobservice&#45;&gt;ffmpegbaseline -->
<g id="edge11" class="edge">
<title>previewrenderjobservice&#45;&gt;ffmpegbaseline</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M1627.65,-1614.19C1619.12,-1494.78 1603.99,-1283.13 1595.09,-1158.63"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="1597.73,-1158.65 1594.57,-1151.35 1592.49,-1159.02 1597.73,-1158.65"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="1617.07,-1369.8 1617.07,-1392.6 1731.23,-1392.6 1731.23,-1369.8 1617.07,-1369.8"/>
<text xml:space="preserve" text-anchor="start" x="1620.07" y="-1375.6" font-family="Arial" font-size="14.00" fill="#c9c9c9">executes preview</text>
</g>
<!-- previewrenderjobservice&#45;&gt;productruntime -->
<g id="edge12" class="edge">
<title>previewrenderjobservice&#45;&gt;productruntime</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M1689.45,-1614.19C1713.58,-1572.17 1740.32,-1520.5 1758,-1471.2 1836.79,-1251.51 1877.35,-978.87 1894.56,-835.45"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="1897.13,-836.12 1895.4,-828.36 1891.91,-835.5 1897.13,-836.12"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="1831,-1208.4 1831,-1231.2 1933.5,-1231.2 1933.5,-1208.4 1831,-1208.4"/>
<text xml:space="preserve" text-anchor="start" x="1834" y="-1214.2" font-family="Arial" font-size="14.00" fill="#c9c9c9">creates product</text>
</g>
<!-- previewartifactqueryservice&#45;&gt;productruntime -->
<g id="edge13" class="edge">
<title>previewartifactqueryservice&#45;&gt;productruntime</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M2179.65,-968.47C2129.41,-926.05 2069.23,-875.25 2018.03,-832.02"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="2019.96,-830.21 2012.54,-827.38 2016.57,-834.23 2019.96,-830.21"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="2106.39,-885.6 2106.39,-908.4 2208.9,-908.4 2208.9,-885.6 2106.39,-885.6"/>
<text xml:space="preserve" text-anchor="start" x="2109.39" y="-891.4" font-family="Arial" font-size="14.00" fill="#c9c9c9">queries product</text>
</g>
<!-- previewartifactqueryservice&#45;&gt;storageruntime -->
<g id="edge14" class="edge">
<title>previewartifactqueryservice&#45;&gt;storageruntime</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M2271.89,-968.59C2254.27,-849.18 2223.02,-637.53 2204.65,-513.03"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="2207.26,-512.77 2203.57,-505.73 2202.07,-513.53 2207.26,-512.77"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="2250.03,-724.2 2250.03,-747 2352.54,-747 2352.54,-724.2 2250.03,-724.2"/>
<text xml:space="preserve" text-anchor="start" x="2253.03" y="-730" font-family="Arial" font-size="14.00" fill="#c9c9c9">queries storage</text>
</g>
<!-- assstylemapper&#45;&gt;providerbinding -->
<g id="edge15" class="edge">
<title>assstylemapper&#45;&gt;providerbinding</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M725.51,-1614.37C725.05,-1594.51 724.64,-1573.53 724.4,-1554 724.12,-1530.48 724.35,-1505.16 724.81,-1481.37"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="727.43,-1481.5 724.96,-1473.95 722.18,-1481.39 727.43,-1481.5"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="724.4,-1531.2 724.4,-1554 837,-1554 837,-1531.2 724.4,-1531.2"/>
<text xml:space="preserve" text-anchor="start" x="727.4" y="-1537" font-family="Arial" font-size="14.00" fill="#c9c9c9">resolves provider</text>
</g>
<!-- renderjobclaimservice&#45;&gt;providerregistry -->
<g id="edge16" class="edge">
<title>renderjobclaimservice&#45;&gt;providerregistry</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M318.55,-1291.39C407.12,-1171.38 564.45,-958.21 656.15,-833.96"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="658.22,-835.56 660.56,-827.97 654,-832.45 658.22,-835.56"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="553.17,-1047 553.17,-1069.8 657.98,-1069.8 657.98,-1047 553.17,-1047"/>
<text xml:space="preserve" text-anchor="start" x="556.17" y="-1052.8" font-family="Arial" font-size="14.00" fill="#c9c9c9">verifies provider</text>
</g>
<!-- providerbinding&#45;&gt;ffmpegbaseline -->
<g id="edge17" class="edge">
<title>providerbinding&#45;&gt;ffmpegbaseline</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M887.92,-1313.02C906.44,-1305.53 925.1,-1298.12 943,-1291.2 1103.26,-1229.27 1287.92,-1163.46 1418.48,-1117.85"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="1419.11,-1120.41 1425.32,-1115.46 1417.38,-1115.46 1419.11,-1120.41"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="1154.79,-1208.4 1154.79,-1231.2 1297.7,-1231.2 1297.7,-1208.4 1154.79,-1208.4"/>
<text xml:space="preserve" text-anchor="start" x="1157.79" y="-1214.2" font-family="Arial" font-size="14.00" fill="#c9c9c9">routes PRODUCTION</text>
</g>
<!-- providerbinding&#45;&gt;providerregistry -->
<g id="edge18" class="edge">
<title>providerbinding&#45;&gt;providerregistry</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M728,-1291.39C728,-1171.98 728,-960.33 728,-835.83"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="730.63,-836.06 728,-828.56 725.38,-836.06 730.63,-836.06"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="728,-1047 728,-1069.8 885.74,-1069.8 885.74,-1047 728,-1047"/>
<text xml:space="preserve" text-anchor="start" x="731" y="-1052.8" font-family="Arial" font-size="14.00" fill="#c9c9c9">resolves by canonical ID</text>
</g>
<!-- ffmpegbaseline&#45;&gt;productruntime -->
<g id="edge19" class="edge">
<title>ffmpegbaseline&#45;&gt;productruntime</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M1652.73,-968.79C1674.42,-941.12 1699.5,-911.16 1724.59,-885.6 1742.43,-867.43 1762.35,-849.22 1782.26,-832.09"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="1783.88,-834.16 1787.88,-827.29 1780.47,-830.17 1783.88,-834.16"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="1724.59,-885.6 1724.59,-908.4 1831,-908.4 1831,-885.6 1724.59,-885.6"/>
<text xml:space="preserve" text-anchor="start" x="1727.59" y="-891.4" font-family="Arial" font-size="14.00" fill="#c9c9c9">produces output</text>
</g>
<!-- ffmpegbaseline&#45;&gt;providerregistry -->
<g id="edge20" class="edge">
<title>ffmpegbaseline&#45;&gt;providerregistry</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M1428,-997.72C1280.36,-942.64 1061.38,-860.96 907.76,-803.65"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="908.98,-801.31 901.03,-801.15 907.14,-806.23 908.98,-801.31"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="1183.79,-885.6 1183.79,-908.4 1308.83,-908.4 1308.83,-885.6 1183.79,-885.6"/>
<text xml:space="preserve" text-anchor="start" x="1186.79" y="-891.4" font-family="Arial" font-size="14.00" fill="#c9c9c9">registers as ffmpeg</text>
</g>
<!-- productruntime&#45;&gt;storageruntime -->
<g id="edge21" class="edge">
<title>productruntime&#45;&gt;storageruntime</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M1984.01,-645.67C2021.38,-603.6 2066.08,-553.28 2104.28,-510.29"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="2106.05,-512.24 2109.07,-504.89 2102.13,-508.76 2106.05,-512.24"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="2056.05,-562.8 2056.05,-585.6 2173.32,-585.6 2173.32,-562.8 2056.05,-562.8"/>
<text xml:space="preserve" text-anchor="start" x="2059.05" y="-568.6" font-family="Arial" font-size="14.00" fill="#c9c9c9">manages lifecycle</text>
</g>
<!-- storageruntime&#45;&gt;storage -->
<g id="edge22" class="edge">
<title>storageruntime&#45;&gt;storage</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M2190,-322.87C2190,-281.67 2190,-232.56 2190,-190.17"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="2192.63,-190.36 2190,-182.86 2187.38,-190.36 2192.63,-190.36"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="2190,-240 2190,-262.8 2297.14,-262.8 2297.14,-240 2190,-240"/>
<text xml:space="preserve" text-anchor="start" x="2193" y="-245.8" font-family="Arial" font-size="14.00" fill="#c9c9c9">persists artifacts</text>
</g>
<!-- platformapp&#45;&gt;previewrenderjobservice -->
<g id="edge1" class="edge">
<title>platformapp&#45;&gt;previewrenderjobservice</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M2572.36,-1942.04C2567.88,-1940.22 2563.42,-1938.47 2559,-1936.8 2303.05,-1840.36 1992.21,-1771.86 1803.93,-1735.4"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="1804.5,-1732.83 1796.63,-1733.99 1803.5,-1737.99 1804.5,-1732.83"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="2361.21,-1854 2361.21,-1876.8 2445.81,-1876.8 2445.81,-1854 2361.21,-1854"/>
<text xml:space="preserve" text-anchor="start" x="2364.21" y="-1859.8" font-family="Arial" font-size="14.00" fill="#c9c9c9">exposes API</text>
</g>
<!-- platformapp&#45;&gt;previewartifactqueryservice -->
<g id="edge2" class="edge">
<title>platformapp&#45;&gt;previewartifactqueryservice</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M2729.6,-1937C2721.1,-1776.6 2683.44,-1434.24 2519,-1208.4 2501.23,-1184 2478.15,-1162.62 2453.4,-1144.24"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="2455.02,-1142.17 2447.41,-1139.9 2451.94,-1146.42 2455.02,-1142.17"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="2671.7,-1531.2 2671.7,-1554 2756.3,-1554 2756.3,-1531.2 2671.7,-1531.2"/>
<text xml:space="preserve" text-anchor="start" x="2674.7" y="-1537" font-family="Arial" font-size="14.00" fill="#c9c9c9">exposes API</text>
</g>
</g>
</svg>
...
`;case`renderJobClaimFailureArchitecture`:return`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN"
 "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
<!-- Generated by graphviz version 14.1.5 (0)
 -->
<!-- Pages: 1 -->
<svg width="2220pt" height="1178pt"
 viewBox="0.00 0.00 2220.00 1178.00" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
<g id="graph0" class="graph" transform="scale(1 1) rotate(0) translate(15.05 1163.45)">
<!-- previewrenderjobservice -->
<g id="node1" class="node">
<title>previewrenderjobservice</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="1405.7,-1148.4 1085.66,-1148.4 1085.66,-968.4 1405.7,-968.4 1405.7,-1148.4"/>
<text xml:space="preserve" text-anchor="start" x="1119.51" y="-1061.4" font-family="Arial" font-size="20.00" fill="#eff6ff">Preview Render Job Service</text>
<text xml:space="preserve" text-anchor="start" x="1133.96" y="-1038.4" font-family="Arial" font-size="15.00" fill="#bfdbfe">VS.1: Preview render job lifecycle</text>
</g>
<!-- renderjobclaimservice -->
<g id="node2" class="node">
<title>renderjobclaimservice</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="409.36,-825.6 0,-825.6 0,-645.6 409.36,-645.6 409.36,-825.6"/>
<text xml:space="preserve" text-anchor="start" x="91.3" y="-747.6" font-family="Arial" font-size="20.00" fill="#eff6ff">RenderJob Claim Service</text>
<text xml:space="preserve" text-anchor="start" x="20.06" y="-724.6" font-family="Arial" font-size="15.00" fill="#bfdbfe">Atomic CAS: QUEUED → SELECTING_PROVIDER via</text>
<text xml:space="preserve" text-anchor="start" x="105.07" y="-706.6" font-family="Arial" font-size="15.00" fill="#bfdbfe">REQUIRES_NEW transaction</text>
</g>
<!-- renderjobfailureservice -->
<g id="node3" class="node">
<title>renderjobfailureservice</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="928.36,-825.6 519.01,-825.6 519.01,-645.6 928.36,-645.6 928.36,-825.6"/>
<text xml:space="preserve" text-anchor="start" x="605.29" y="-756.6" font-family="Arial" font-size="20.00" fill="#eff6ff">RenderJob Failure Service</text>
<text xml:space="preserve" text-anchor="start" x="559.87" y="-733.6" font-family="Arial" font-size="15.00" fill="#bfdbfe">Durable failure persistence via REQUIRES_NEW</text>
<text xml:space="preserve" text-anchor="start" x="569.46" y="-715.6" font-family="Arial" font-size="15.00" fill="#bfdbfe">transaction. States: SELECTING_PROVIDER,</text>
<text xml:space="preserve" text-anchor="start" x="539.06" y="-697.6" font-family="Arial" font-size="15.00" fill="#bfdbfe">PROVIDER_SELECTED, EXECUTING, COMPLETING</text>
</g>
<!-- renderjobstatemachine -->
<g id="node4" class="node">
<title>renderjobstatemachine</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="1453.28,-825.6 1038.08,-825.6 1038.08,-645.6 1453.28,-645.6 1453.28,-825.6"/>
<text xml:space="preserve" text-anchor="start" x="1130.06" y="-756.6" font-family="Arial" font-size="20.00" fill="#eff6ff">RenderJob State Machine</text>
<text xml:space="preserve" text-anchor="start" x="1135.65" y="-733.6" font-family="Arial" font-size="15.00" fill="#bfdbfe">Lifecycle transitions: QUEUED →</text>
<text xml:space="preserve" text-anchor="start" x="1058.13" y="-715.6" font-family="Arial" font-size="15.00" fill="#bfdbfe">SELECTING_PROVIDER → PROVIDER_SELECTED →</text>
<text xml:space="preserve" text-anchor="start" x="1084.83" y="-697.6" font-family="Arial" font-size="15.00" fill="#bfdbfe">EXECUTING → COMPLETING → COMPLETED</text>
</g>
<!-- providerbinding -->
<g id="node5" class="node">
<title>providerbinding</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="1883.7,-825.6 1563.66,-825.6 1563.66,-645.6 1883.7,-645.6 1883.7,-825.6"/>
<text xml:space="preserve" text-anchor="start" x="1650.31" y="-747.6" font-family="Arial" font-size="20.00" fill="#eff6ff">Provider Binding</text>
<text xml:space="preserve" text-anchor="start" x="1589.68" y="-724.6" font-family="Arial" font-size="15.00" fill="#bfdbfe">Deterministic eligibility + priority provider</text>
<text xml:space="preserve" text-anchor="start" x="1694.08" y="-706.6" font-family="Arial" font-size="15.00" fill="#bfdbfe">selection</text>
</g>
<!-- ffmpegbaseline -->
<g id="node6" class="node">
<title>ffmpegbaseline</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="2189.7,-502.8 1869.66,-502.8 1869.66,-322.8 2189.7,-322.8 2189.7,-502.8"/>
<text xml:space="preserve" text-anchor="start" x="1922.97" y="-415.8" font-family="Arial" font-size="20.00" fill="#eff6ff">FFmpeg/libass Baseline</text>
<text xml:space="preserve" text-anchor="start" x="1930.03" y="-392.8" font-family="Arial" font-size="15.00" fill="#bfdbfe">Production rendering baseline</text>
</g>
<!-- providerregistry -->
<g id="node7" class="node">
<title>providerregistry</title>
<polygon fill="#3b82f6" stroke="#2563eb" stroke-width="0" points="1772.22,-180 1431.14,-180 1431.14,0 1772.22,0 1772.22,-180"/>
<text xml:space="preserve" text-anchor="start" x="1524.99" y="-102" font-family="Arial" font-size="20.00" fill="#eff6ff">Provider Registry</text>
<text xml:space="preserve" text-anchor="start" x="1451.2" y="-79" font-family="Arial" font-size="15.00" fill="#bfdbfe">Canonical Provider ID management. Registry</text>
<text xml:space="preserve" text-anchor="start" x="1505.39" y="-61" font-family="Arial" font-size="15.00" fill="#bfdbfe">key: ffmpeg (not class name)</text>
</g>
<!-- previewrenderjobservice&#45;&gt;renderjobclaimservice -->
<g id="edge1" class="edge">
<title>previewrenderjobservice&#45;&gt;renderjobclaimservice</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M1085.94,-1012.22C927.46,-966.88 677.96,-894.14 463.68,-825.6 449.1,-820.94 434.09,-816.04 418.99,-811.04"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="419.87,-808.57 411.93,-808.69 418.22,-813.55 419.87,-808.57"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="720.78,-885.6 720.78,-908.4 830.27,-908.4 830.27,-885.6 720.78,-885.6"/>
<text xml:space="preserve" text-anchor="start" x="723.78" y="-891.4" font-family="Arial" font-size="14.00" fill="#c9c9c9">claims execution</text>
</g>
<!-- previewrenderjobservice&#45;&gt;renderjobfailureservice -->
<g id="edge2" class="edge">
<title>previewrenderjobservice&#45;&gt;renderjobfailureservice</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M1100.97,-968.47C1031.24,-925.61 947.59,-874.2 876.79,-830.7"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="878.57,-828.7 870.8,-827.01 875.82,-833.18 878.57,-828.7"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="1000.33,-885.6 1000.33,-908.4 1095.04,-908.4 1095.04,-885.6 1000.33,-885.6"/>
<text xml:space="preserve" text-anchor="start" x="1003.33" y="-891.4" font-family="Arial" font-size="14.00" fill="#c9c9c9">records failure</text>
</g>
<!-- previewrenderjobservice&#45;&gt;renderjobstatemachine -->
<g id="edge3" class="edge">
<title>previewrenderjobservice&#45;&gt;renderjobstatemachine</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M1245.68,-968.47C1245.68,-927.27 1245.68,-878.16 1245.68,-835.77"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="1248.31,-835.96 1245.68,-828.46 1243.06,-835.96 1248.31,-835.96"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="1245.68,-885.6 1245.68,-908.4 1349.73,-908.4 1349.73,-885.6 1245.68,-885.6"/>
<text xml:space="preserve" text-anchor="start" x="1248.68" y="-891.4" font-family="Arial" font-size="14.00" fill="#c9c9c9">transitions state</text>
</g>
<!-- previewrenderjobservice&#45;&gt;providerbinding -->
<g id="edge4" class="edge">
<title>previewrenderjobservice&#45;&gt;providerbinding</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M1378.2,-968.47C1441.79,-925.79 1518.03,-874.62 1582.69,-831.23"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="1584.04,-833.48 1588.81,-827.12 1581.12,-829.12 1584.04,-833.48"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="1499.01,-885.6 1499.01,-908.4 1590.61,-908.4 1590.61,-885.6 1499.01,-885.6"/>
<text xml:space="preserve" text-anchor="start" x="1502.01" y="-891.4" font-family="Arial" font-size="14.00" fill="#c9c9c9">compiles plan</text>
</g>
<!-- previewrenderjobservice&#45;&gt;ffmpegbaseline -->
<g id="edge5" class="edge">
<title>previewrenderjobservice&#45;&gt;ffmpegbaseline</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M1405.37,-1041.29C1559.26,-1017.98 1790.04,-961.49 1938.68,-825.6 2031.51,-740.74 2049.57,-688.44 2043.68,-562.8 2042.93,-546.68 2041.71,-529.61 2040.31,-513"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="2042.94,-512.99 2039.68,-505.75 2037.71,-513.45 2042.94,-512.99"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="2042.66,-724.2 2042.66,-747 2156.82,-747 2156.82,-724.2 2042.66,-724.2"/>
<text xml:space="preserve" text-anchor="start" x="2045.66" y="-730" font-family="Arial" font-size="14.00" fill="#c9c9c9">executes preview</text>
</g>
<!-- renderjobclaimservice&#45;&gt;providerregistry -->
<g id="edge6" class="edge">
<title>renderjobclaimservice&#45;&gt;providerregistry</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M397.83,-645.62C668.87,-520.75 1158.34,-295.25 1421.95,-173.8"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="1422.77,-176.32 1428.48,-170.79 1420.57,-171.55 1422.77,-176.32"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="1087.49,-401.4 1087.49,-424.2 1192.3,-424.2 1192.3,-401.4 1087.49,-401.4"/>
<text xml:space="preserve" text-anchor="start" x="1090.49" y="-407.2" font-family="Arial" font-size="14.00" fill="#c9c9c9">verifies provider</text>
</g>
<!-- providerbinding&#45;&gt;ffmpegbaseline -->
<g id="edge7" class="edge">
<title>providerbinding&#45;&gt;ffmpegbaseline</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M1801.4,-645.77C1825.52,-618.8 1852.43,-589.29 1877.77,-562.8 1894.3,-545.51 1912.19,-527.44 1929.69,-510.08"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="1931.52,-511.96 1935.01,-504.82 1927.83,-508.23 1931.52,-511.96"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="1877.77,-562.8 1877.77,-585.6 2020.68,-585.6 2020.68,-562.8 1877.77,-562.8"/>
<text xml:space="preserve" text-anchor="start" x="1880.77" y="-568.6" font-family="Arial" font-size="14.00" fill="#c9c9c9">routes PRODUCTION</text>
</g>
<!-- providerbinding&#45;&gt;providerregistry -->
<g id="edge8" class="edge">
<title>providerbinding&#45;&gt;providerregistry</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M1694.75,-645.66C1681.69,-602.84 1666.96,-550.55 1656.94,-502.8 1634.72,-396.91 1619.57,-273.74 1610.83,-189.88"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="1613.46,-189.8 1610.08,-182.61 1608.24,-190.34 1613.46,-189.8"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="1656.94,-401.4 1656.94,-424.2 1814.68,-424.2 1814.68,-401.4 1656.94,-401.4"/>
<text xml:space="preserve" text-anchor="start" x="1659.94" y="-407.2" font-family="Arial" font-size="14.00" fill="#c9c9c9">resolves by canonical ID</text>
</g>
<!-- ffmpegbaseline&#45;&gt;providerregistry -->
<g id="edge9" class="edge">
<title>ffmpegbaseline&#45;&gt;providerregistry</title>
<path fill="none" stroke="#8d8d8d" stroke-width="2" stroke-dasharray="5,2" d="M1911.03,-322.87C1854.2,-280.27 1786.1,-229.23 1728.28,-185.89"/>
<polygon fill="#8d8d8d" stroke="#8d8d8d" stroke-width="2" points="1730.19,-184.04 1722.62,-181.65 1727.04,-188.24 1730.19,-184.04"/>
<polygon fill="#18191b" fill-opacity="0.627451" stroke="none" points="1828.51,-240 1828.51,-262.8 1953.56,-262.8 1953.56,-240 1828.51,-240"/>
<text xml:space="preserve" text-anchor="start" x="1831.51" y="-245.8" font-family="Arial" font-size="14.00" fill="#c9c9c9">registers as ffmpeg</text>
</g>
</g>
</svg>
