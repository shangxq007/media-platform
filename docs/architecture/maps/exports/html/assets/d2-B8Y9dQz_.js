...
MediaPlatformRenderModule: {
  ...
  RenderJobClaimService: {
    label: "RenderJob Claim Service"
  }
  RenderJobFailureService: {
    label: "RenderJob Failure Service"
  }
  RenderJobStateMachine: {
    label: "RenderJob State Machine"
  }
  ProviderBinding: {
...
MediaPlatformRenderModule.ProviderBinding -> MediaPlatformRenderModule.ProviderRegistry: "resolves by canonical ID"
...
MediaPlatformRenderModule.FfmpegBaseline -> MediaPlatformRenderModule.ProviderRegistry: "registers as ffmpeg"
...
MediaPlatformRenderModule.PreviewRenderJobService -> MediaPlatformRenderModule.RenderJobClaimService: "claims execution"
MediaPlatformRenderModule.PreviewRenderJobService -> MediaPlatformRenderModule.RenderJobFailureService: "records failure"
MediaPlatformRenderModule.PreviewRenderJobService -> MediaPlatformRenderModule.RenderJobStateMachine: "transitions state"
...
MediaPlatformRenderModule.RenderJobClaimService -> MediaPlatformRenderModule.ProviderRegistry: "verifies provider"
...
`;case`renderJobClaimFailureArchitecture`:return`direction: down

MediaPlatformRenderModulePreviewRenderJobService: {
  label: "Preview Render Job Service"
}
MediaPlatformRenderModuleRenderJobClaimService: {
  label: "RenderJob Claim Service"
}
MediaPlatformRenderModuleRenderJobFailureService: {
  label: "RenderJob Failure Service"
}
MediaPlatformRenderModuleRenderJobStateMachine: {
  label: "RenderJob State Machine"
}
MediaPlatformRenderModuleProviderBinding: {
  label: "Provider Binding"
...
MediaPlatformRenderModuleProviderRegistry: {
  label: "Provider Registry"
}

MediaPlatformRenderModulePreviewRenderJobService -> MediaPlatformRenderModuleRenderJobClaimService: "claims execution"
MediaPlatformRenderModulePreviewRenderJobService -> MediaPlatformRenderModuleRenderJobFailureService: "records failure"
MediaPlatformRenderModulePreviewRenderJobService -> MediaPlatformRenderModuleRenderJobStateMachine: "transitions state"
MediaPlatformRenderModuleRenderJobClaimService -> MediaPlatformRenderModuleProviderRegistry: "verifies provider"
MediaPlatformRenderModulePreviewRenderJobService -> MediaPlatformRenderModuleProviderBinding: "compiles plan"
MediaPlatformRenderModuleProviderBinding -> MediaPlatformRenderModuleProviderRegistry: "resolves by canonical ID"
MediaPlatformRenderModulePreviewRenderJobService -> MediaPlatformRenderModuleFfmpegBaseline: "executes preview"
MediaPlatformRenderModuleProviderBinding -> MediaPlatformRenderModuleFfmpegBaseline: "routes PRODUCTION"
MediaPlatformRenderModuleFfmpegBaseline -> MediaPlatformRenderModuleProviderRegistry: "registers as ffmpeg"
