...
skinparam rectangle<<MediaPlatformRenderModuleRenderJobClaimService>>{
  BackgroundColor #3b82f6
  FontColor #eff6ff
  BorderColor #2563eb
}
skinparam rectangle<<MediaPlatformRenderModuleRenderJobFailureService>>{
  BackgroundColor #3b82f6
  FontColor #eff6ff
  BorderColor #2563eb
}
skinparam rectangle<<MediaPlatformRenderModuleRenderJobStateMachine>>{
  BackgroundColor #3b82f6
  FontColor #eff6ff
  BorderColor #2563eb
}
...
skinparam rectangle<<MediaPlatformRenderModuleProviderRegistry>>{
  BackgroundColor #3b82f6
  FontColor #eff6ff
  BorderColor #2563eb
}
...
rectangle "render-module" <<MediaPlatformRenderModule>> as MediaPlatformRenderModule {
  ...
  rectangle "==RenderJob Claim Service\\n\\nAtomic CAS: QUEUED → SELECTING_PROVIDER via REQUIRES_NEW transaction" <<MediaPlatformRenderModuleRenderJobClaimService>> as MediaPlatformRenderModuleRenderJobClaimService
  rectangle "==RenderJob Failure Service\\n\\nDurable failure persistence via REQUIRES_NEW transaction. States: SELECTING_PROVIDER, PROVIDER_SELECTED, EXECUTING, COMPLETING" <<MediaPlatformRenderModuleRenderJobFailureService>> as MediaPlatformRenderModuleRenderJobFailureService
  rectangle "==RenderJob State Machine\\n\\nLifecycle transitions: QUEUED → SELECTING_PROVIDER → PROVIDER_SELECTED → EXECUTING → COMPLETING → COMPLETED" <<MediaPlatformRenderModuleRenderJobStateMachine>> as MediaPlatformRenderModuleRenderJobStateMachine
  ...
  rectangle "==Provider Registry\\n\\nCanonical Provider ID management. Registry key: ffmpeg (not class name)" <<MediaPlatformRenderModuleProviderRegistry>> as MediaPlatformRenderModuleProviderRegistry
...
MediaPlatformRenderModuleProviderBinding .[#8D8D8D,thickness=2].> MediaPlatformRenderModuleProviderRegistry : <color:#8D8D8D>resolves by canonical ID
...
MediaPlatformRenderModuleFfmpegBaseline .[#8D8D8D,thickness=2].> MediaPlatformRenderModuleProviderRegistry : <color:#8D8D8D>registers as ffmpeg
...
MediaPlatformRenderModulePreviewRenderJobService .[#8D8D8D,thickness=2].> MediaPlatformRenderModuleRenderJobClaimService : <color:#8D8D8D>claims execution
MediaPlatformRenderModulePreviewRenderJobService .[#8D8D8D,thickness=2].> MediaPlatformRenderModuleRenderJobFailureService : <color:#8D8D8D>records failure
MediaPlatformRenderModulePreviewRenderJobService .[#8D8D8D,thickness=2].> MediaPlatformRenderModuleRenderJobStateMachine : <color:#8D8D8D>transitions state
...
MediaPlatformRenderModuleRenderJobClaimService .[#8D8D8D,thickness=2].> MediaPlatformRenderModuleProviderRegistry : <color:#8D8D8D>verifies provider
...
@enduml
`;case`renderJobClaimFailureArchitecture`:return`@startuml
