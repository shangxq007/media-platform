...
| TimelineSourceBinding | **TimelineSourceBinding / MediaStreamSourceBinding** (typed sealed root) | TimelineSourceBindingCanonicalSemantics | TimelineSourceBindingCanonicalSemantics | TimelineSourceBindingCanonicalSemantics | TimelineSourceBindingCanonicalSemantics | TimelineSourceBindingCanonicalSemantics (STRICT + FINAL_CLOSURE_F2: source kind / media asset id / media stream id / artifact id / content digest ALGORITHM (authored, validated — no SHA_256 hardcode) / content digest VALUE / exact source range all FAIL CLOSED; flat range NO semantic defaults (no fps=30/den=1/frame=0 synthesis)) | TimelineSourceBindingCanonicalSemantics | TimelineSourceBindingCanonicalSemantics (fromCanonicalValue / fromFlatFields) | TimelineSourceBindingCanonicalSemantics (nested sourceBinding object) | Timeline: clip association, placement, delete-vs-modify, cross-object validation |
