...
public final class PluginSelectionToRequestMapper {
    ...
    public static PluginExecutionRequest toRequest(
            ...
            String tenantId,
            com.example.platform.usage.api.CanonicalActorRef actorRef,
            com.example.platform.usage.api.OperationRef operationRef,
            Object input,
        ...
        return new PluginExecutionRequest(
                ...
                new com.example.platform.usage.api.ProviderRef(selection.pluginId()),
                input,
                executionMode,
                timeout,
