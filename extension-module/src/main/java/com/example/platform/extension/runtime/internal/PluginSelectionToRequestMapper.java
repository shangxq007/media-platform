...
public final class PluginSelectionToRequestMapper {
    ...
    public static PluginExecutionRequest toRequest(
            ...
            String tenantId,
            com.example.platform.billing.usage.CanonicalActorRef actorRef,
            com.example.platform.billing.usage.OperationRef operationRef,
            Object input,
        ...
        return new PluginExecutionRequest(
                ...
                new com.example.platform.billing.usage.ProviderRef(selection.pluginId()),
                input,
                executionMode,
                timeout,
