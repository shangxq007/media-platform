...
public record AuthorizationDecision(
    ...
    public static AuthorizationDecision allow(String planDigest, String principalRef,
                                              String projectId, String targetRefId, String policyVersion) {
        return new AuthorizationDecision(true, planDigest, principalRef, projectId, targetRefId,
                policyVersion, OffsetDateTime.now());
    }

    public static AuthorizationDecision deny(String planDigest, String principalRef,
                                             String projectId, String targetRefId, String policyVersion) {
        return new AuthorizationDecision(false, planDigest, principalRef, projectId, targetRefId,
                policyVersion, OffsetDateTime.now());
    }
}
