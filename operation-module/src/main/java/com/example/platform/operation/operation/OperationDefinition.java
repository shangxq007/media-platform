...
public record OperationDefinition(
    ...
    public static final class V1 {
        ...
        public static final OperationDefinition ADD_OR_TRIM_MEDIA_CLIP = new OperationDefinition(
                OperationDefinitionId.of("timeline.media-clip.add-or-trim"),
                OperationDefinitionVersion.of(1, 0), Lifecycle.ACTIVE, TargetKind.TIMELINE,
                1, 1, OperationParameters.AddOrTrimMediaClipParameters.class);
