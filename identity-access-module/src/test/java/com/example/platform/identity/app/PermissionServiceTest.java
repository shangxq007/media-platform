...
class PermissionServiceTest {
    ...
    void hasPermissionReturnsTrueWhenUserHasPermission() {
        ...
        UserRoleAssignment assignment = new UserRoleAssignment("ura_1", "tenant-a", "ws_1", "usr_1", "rol_1", null, Instant.now());
        ...
        assertTrue(permissionService.hasPermission("usr_1", "tenant-a", "ws_1", "render.submit"));
    }
    ...
    void hasPermissionReturnsFalseWhenUserLacksPermission() {
        ...
        assertFalse(permissionService.hasPermission("usr_2", "tenant-a", "ws_1", "render.submit"));
    }
    ...
    void hasPermissionReturnsFalseForUnknownPermission() {
        ...
        assertFalse(permissionService.hasPermission("usr_1", "tenant-a", "ws_1", "billing.manage"));
    }
