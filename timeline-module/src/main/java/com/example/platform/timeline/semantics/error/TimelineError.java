package com.example.platform.timeline.semantics.error;
...
public sealed interface TimelineError {
    ...
    public enum ErrorCode {
        ...
        TIMELINE_DURATION_INCONSISTENT("TIMELINE_DURATION_INCONSISTENT"),
        TIMELINE_FREEZE_POSITION_INVALID("TIMELINE_FREEZE_POSITION_INVALID"),
