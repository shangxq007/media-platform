package com.example.platform.timeline.diff.merge.preview;
    ...
    void failedDetectorExceptionConvertsToSafeFailed() {
        ...
        TimelineMergeConflictDetector throwingDetector = new TimelineMergeConflictDetector() {
            ...
            public TimelineMergeConflictAnalysis analyze(
                    com.example.platform.timeline.diff.calculation.CanonicalTimelineSnapshot base,
                    com.example.platform.timeline.diff.calculation.CanonicalTimelineSnapshot ours,
                    com.example.platform.timeline.diff.calculation.CanonicalTimelineSnapshot theirs) {
