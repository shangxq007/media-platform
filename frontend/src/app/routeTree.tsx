...
const NlePage = lazy(() => import('../surfaces/FoundationPages.js').then(module => ({ default: module.NlePage })))
const CanvasPage = lazy(() => import('../surfaces/FoundationPages.js').then(module => ({ default: module.CanvasPage })))
...
const ReviewPage = lazy(() => import('../surfaces/FoundationPages.js').then(module => ({ default: module.ReviewPage })))
