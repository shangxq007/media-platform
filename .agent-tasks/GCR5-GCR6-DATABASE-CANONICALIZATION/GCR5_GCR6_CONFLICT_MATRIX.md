...
timeline_revision.tenant_id initially appeared nullable/redundant | column is ACTIVELY consumed by Timeline tenant guards (TimelineRevisionRepository:132 tenant guard, TimelineSnapshotService, TimelineRevisionSaveService:118) | timeline | nullable tenant_id retained | removing it would break active fail-closed tenant isolation assumptions | KEEP | NO_CHANGE | RESOLVED_BY_REALITY_ADJUDICATION; ACTIVE_TENANT_GUARD_COLUMN (DELETE considered during initial review, superseded by deeper repository reality)
