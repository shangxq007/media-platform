...
tasks.register("verifyGcr2ArtifactAuthority") {
    ...
    doLast {
        ...
        require(migrations.map { it.name }.toSet() == setOf("V1__initial_schema.sql", "V2__account_membership_and_project_scope.sql", "V3__quarantine_unresolved_assignment_scopes.sql", "V4__quarantine_missing_assignment_tenants.sql", "V5__workflow_durable_runs.sql", "V6__marketplace_owner.sql", "V7__marketplace_event_retirement.sql")) {
...
tasks.register("verifyGcr5Gcr6DatabaseCanonicalization") {
    ...
    doLast {
        ...
        require(scripts.map { it.name }.toSet() == setOf("V1__initial_schema.sql", "V2__account_membership_and_project_scope.sql", "V3__quarantine_unresolved_assignment_scopes.sql", "V4__quarantine_missing_assignment_tenants.sql", "V5__workflow_durable_runs.sql", "V6__marketplace_owner.sql", "V7__marketplace_event_retirement.sql")) {
