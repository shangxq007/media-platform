...
def test_repository_policy() -> None:
    ...
    require(len(declared) == 54, f"expected Phase A 51 plus Marketplace, Usage and Audit declared Test task, got {len(declared)}")
    ...
    require(report.task_count == 54, f"expected Phase A 51 plus Marketplace, Usage and Audit active Test task, got {report.task_count}")
