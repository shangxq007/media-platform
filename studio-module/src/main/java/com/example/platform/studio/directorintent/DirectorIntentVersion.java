...
public final class DirectorIntentVersion implements com.example.platform.studio.digest.CanonicalStudioVersion {
    ...
    public byte[] canonicalBytes(){return canonicalBytes.clone();}public ContentDigest semanticDigest(){return semanticDigest;}public Emphasis emphasis(){return emphasis;}public EmotionalTone emotionalTone(){return emotionalTone;}public CameraMovementIntent movementIntent(){return movementIntent;}public LightingMood lightingMood(){return lightingMood;}public List<String> annotations(){return annotations;}
}
